...
signals:
    ...
    void CLMessReadyForSending ( const CHostAddress& InetAddr, CVector<uint8_t> vecMessage, CTcpConnection* pTcpConnection );
    ...
    void CLReqServerList ( const CHostAddress& InetAddr, CTcpConnection* pTcpConnection );
    ...
    void CLReqConnClientsList ( const CHostAddress& InetAddr, CTcpConnection* pTcpConnection );
